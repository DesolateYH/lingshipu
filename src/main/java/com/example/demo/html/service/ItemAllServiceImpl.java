...
public class ItemAllServiceImpl {
    ...
    public void addItemToShopTransactional(Integer shop_id, Integer item_id, Integer stock_mix,int sortId) throws Exception {
        itemService.addItemToShop(shop_id, item_id, stock_mix,sortId);
