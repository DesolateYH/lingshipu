...
import com.example.demo.controller.loginn.HttpRequest;
...
public class LspVxUserServiceImpl {
    ...
    private String wxspAppid = "wx029feb8491d47a9d";
    ...
    public void saveUserInfo(String openid, int place, String name, String gerder) {
        ...
        userInfoModel.setShopId(place);
        userInfoModel.setUserName(name);
        userInfoModel.setAdminId("0");
    ...
    public String decodeUserInfo(String code) {
        ...
        //小程序唯一标识   (在微信小程序管理后台获取)
        String wxspAppid = "wx029feb8491d47a9d";
        //小程序的 app secret (在微信小程序管理后台获取)
        String wxspSecret = "553ad97a1aa40c0c0f9394f75bb2bcd8";
        //授权（必填）
