...
public class ItemServiceImpl {
    ...
    public List getItemAndHomePageMoreRelation() {
        ...
        for (int i = 1; i <= businessService.seachItemNumber(); i++) {
            ...
            Item item = itemDao.findAllByItemId(i);
     ...
     */
    public void addItemToShop(int shop_id, int item_id, int stock_mix,int sortId) throws Exception {
        ...
        itemHomePageMore.setItemSort(sortId);
